...
namespace chem {
    ...
    inline void fopen(std::ifstream& from, const std::string& filename,
    ...
    template<typename T> struct Bound_form;
	...
	Bound_form<T> operator()(T vv) const
	{
	    return Bound_form<T>(*this, vv);
	}
