...
if(WIN32)
	find_path(Numlib_LIBRARY_DIRS numlib.lib HINTS $ENV{Numlib_ROOT}/lib $ENV{HOME}/lib)
else()
    if(APPLE)
	    find_path(Numlib_LIBRARY_DIRS libnumlib.dylib HINTS $ENV{Numlib_ROOT}/lib $ENV{HOME}/lib)
    else()
	    find_path(Numlib_LIBRARY_DIRS libnumlib.so HINTS $ENV{Numlib_ROOT}/lib $ENV{HOME}/lib)
    endif()
endif()

if(Numlib_INCLUDE_DIRS AND Numlib_LIBRARY_DIRS)
    set(Numlib_LIBRARIES "numlib")
    set(Numlib_FOUND ON)
